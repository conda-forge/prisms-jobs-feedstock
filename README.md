...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/prisms-jobs-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/prisms-jobs-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add prisms-jobs
# for installing globally
pixi global install prisms-jobs
```
...
It is possible to list all of the versions of `prisms-jobs` available on your platform:
...
```
pixi search prisms-jobs --channel conda-forge
```
